...
class Article extends Component {
    ...
    render() {
        ...
        const meta = {
            title: 'Fortnite vs Pubg: Feedback Loops - Davis Banks Blog',
            ...
            <DocumentMeta {...meta}>
                <div className="Article">
                    ...
                    <div className="article-content">
                        <h1>Fortnite vs Pubg: Feedback Loops</h1>
                        <div className="section first">
                            <p>
                                Fortnite and Player Unknown's Battlegrounds are both massive battle royale games that
                                launched
                                and gained popularity over the past year. PubG launched into early access on March 2017,
                                with
                                Fortnite launching its Battle Royale mode the following September. At this point PubG is
                                often
                                the top most played game on Steam, while Fortnite seems to be making $22 million a day from
                                its
                                skins sales.
                            </p>
                        </div>
            ...
            <a href="/blog/fortnite-pubg">
                <div className="article-box">
                    ...
                    <div className="box-content">
                        <h3>Fortnite vs PubG: Feedback Loops</h3>
                        <p>
                            As an avid player of both of these games, I want to take a second to reflect on which game
                            won
                            mine and my groups play time lately and why. This will be my opinion on how the gameplay of
                            both
                            games dictated the direction of our group.
                        </p>
                        <div className="time">June 1st, 2018</div>
                    </div>
                </div>
            </a>
        );
